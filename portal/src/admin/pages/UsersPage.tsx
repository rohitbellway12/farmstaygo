...
export default function UsersPage() {
  ...
  const loadUsers = useCallback(async () => {
    try {
      ...
      const response =
        await api.get<UserListResponse>("/admin/users", {
          params: {
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-text-muted">
              Manage customers and platform users.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="flex flex-col gap-4 border-b border-border p-5 xl:flex-row xl:items-center xl:justify-between">
          ...
          <div className="grid gap-3 sm:grid-cols-2 xl:flex">
            ...
            <select
              ...
              className="h-11 min-w-[160px] rounded-control border border-border bg-surface px-4 text-sm font-semibold text-text-secondary outline-none focus:border-primary-400 focus:ring-4 focus:ring-primary-100"
            >
              <option value="ALL">
                All Roles
              </option>
                    ...
                    <td className="px-5 py-4">
                      <div className="flex items-center justify-end gap-2">
                        ...
                        <button
                          ...
                          className={`rounded-control border px-4 py-2 text-xs font-bold transition ${
                            user.status === "ACTIVE"
                              ? "border-warning/20 bg-warning-soft text-warning hover:bg-warning/10"
                              : "border-success/20 bg-success-soft text-success hover:bg-success/10"
                        ...
                        <button
                          ...
                          className="rounded-control border border-danger/20 bg-danger-soft px-4 py-2 text-xs font-bold text-danger transition hover:opacity-80 disabled:cursor-not-allowed disabled:opacity-50"
                        >
                          Delete
                        </button>
