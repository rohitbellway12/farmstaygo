    ...
    <div className="space-y-5">
      ...
      <section className="rounded-dashboard-large border border-border bg-surface p-5 shadow-dashboard">
        ...
        <div className="mt-5 flex flex-wrap gap-3">
          ...
          <Link
            to="/vendor/kyc-bank"
            className="inline-flex h-10 items-center justify-center rounded-control border border-border px-5 text-sm font-bold text-text-secondary hover:bg-surface-muted"
          >
            Manage Bank Details
          </Link>
        </div>
